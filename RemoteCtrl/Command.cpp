...
void CCommand::RunCommand(void* arg, int nStatus, std::list<CPacket>& lstOutPacket, CPacket& inPacket)
{
...
int CCommand::MakeDriverInfo(std::list<CPacket>& lstOutPacket, CPacket& inPacket)//1==>A 2==>B 3==>C ... 26==>Z
{
        std::string strRes;
        for (int i = 1; i <= 26; i++)
        {
...
int CCommand::MakeDirecoryInfo(std::list<CPacket>& lstOutPacket, CPacket& inPacket)
{
...
int CCommand::RunFile(std::list<CPacket>& lstOutPacket, CPacket& inPacket)
{
        std::string strPath = inPacket.strData;
...
int CCommand::DownLoadFile(std::list<CPacket>& lstOutPacket, CPacket& inPacket)
{
		std::string strPath = inPacket.strData;
		long long data = 0;
        FILE* pFile = NULL;
...
int CCommand::MouseEvent(std::list<CPacket>& lstOutPacket, CPacket& inPacket)
{
        MOUSEEVENT mouse;
...
int CCommand::SendScreen(std::list<CPacket>& lstOutPacket, CPacket& inPacket)
{
...
int CCommand::LockMachine(std::list<CPacket>& lstOutPacket, CPacket& inPacket)
{
...
int CCommand::UnLockMachine(std::list<CPacket>& lstOutPacket, CPacket& inPacket)
{
...
int CCommand::TestConnect(std::list<CPacket>& lstOutPacket, CPacket& inPacket)
{
